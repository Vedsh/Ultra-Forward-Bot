...
main_buttons = [[
        InlineKeyboardButton('📢 Updates', url='https://t.me/Unfold_Network'),
        InlineKeyboardButton('💬 Support', url='https://t.me/Unfold_Network')
        ],[
        InlineKeyboardButton('🛠️ Help', callback_data='help'),
        InlineKeyboardButton('🩷 About', callback_data='about')
        ],[
        InlineKeyboardButton('🧑‍💻 Developer 🧑‍💻', url='https://t.me/Unfold_Network')
        ]]
